...
<input className="w-full rounded-2xl border-2 border-outline/50 focus:border-primary focus:ring-primary font-body-md p-4" placeholder="John Doe" type="text"/>
</div>
<div className="space-y-2">
<label className="font-label-md text-label-md text-on-surface-variant px-1">Pet Name</label>
<input className="w-full rounded-2xl border-2 border-outline/50 focus:border-primary focus:ring-primary font-body-md p-4" placeholder="Max" type="text"/>
</div>
<div className="space-y-2">
<label className="font-label-md text-label-md text-on-surface-variant px-1">Pet Type</label>
<select className="w-full rounded-2xl border-2 border-outline/50 focus:border-primary focus:ring-primary font-body-md p-4">
<option>Dog</option>
<option>Cat</option>
<option>Bird</option>
<option>Other</option>
...
<input className="w-full rounded-2xl border-2 border-outline/50 focus:border-primary focus:ring-primary font-body-md p-4" type="date"/>
</div>
<div className="space-y-2">
<label className="font-label-md text-label-md text-on-surface-variant px-1">Preferred Time</label>
<input className="w-full rounded-2xl border-2 border-outline/50 focus:border-primary focus:ring-primary font-body-md p-4" type="time"/>
</div>
